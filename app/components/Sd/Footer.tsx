...
const Footer = () => {
  return (
    <footer className="flex flex-col text-black-100 mt-5 border-t border-gray-100 max-container padding-container">
      ...
      <div className="flex justify-center items-center flex-wrap mt-10 border-t border-gray-100 sm:px-16 px-6 py-10">
        <p>@2024 Yayasan Daarul ATQIYA. All Rights Reserved</p>
      </div>
    </footer>
  );
};
