...
const ProfileSD = () => {
  ...
  const [data, setData] = useState(PROFILESEKOLAH.SD);
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[0].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[1].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[2].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[3].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[4].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[5].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[6].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[7].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[8].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.saranapendidikan[9].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[0].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[1].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[2].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[3].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[4].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[5].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[6].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[7].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[8].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.ekstrakurikuler[9].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.programtahunan[0].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.programtahunan[1].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.programtahunan[2].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.programtahunan[3].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
                              ...
                              <div className="flex w-full flex-col gap-4 justify-start items-start">
                                <div className="flex w-full flex-col">
                                  ...
                                  <input
                                    ...
                                    type="text"
                                    name="nomorIndukAsalSiswa"
                                    value={data.programtahunan[4].title}
                                  />
                                </div>
                                <div className="flex w-full flex-col">
                                  <div className=" flex-1 max-w-[420px] h-full items-center">
